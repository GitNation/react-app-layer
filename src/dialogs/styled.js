 ...
 * In this document we used css variable:
     ...
     --color-brand
     --color-brand-hover
     --color-popup-ticket-button-before
     --color-popup-ticket-button-before
     --color-popup-ticket-border-column
     --color-popup-ticket-input-text
     --color-popup-ticket-input-bg
     --color-popup-ticket-button-form-bg
